...
import 'package:search/domain/usecases/search_tv_series_usecase.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSearchTvUseCase extends _i1.Mock implements _i8.SearchTvUseCase {
  MockSearchTvUseCase() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i6.Future<_i3.Either<_i7.Failure, List<_i4.TvSeries>>> execute(
          String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
        ...
        returnValue:
            _i6.Future<_i3.Either<_i7.Failure, List<_i4.TvSeries>>>.value(
                _FakeEither_1<_i7.Failure, List<_i4.TvSeries>>(
          this,
          Invocation.method(
            #execute,
            [query],
      ...
      ) as _i6.Future<_i3.Either<_i7.Failure, List<_i4.TvSeries>>>);
}
